    ...
    widget.body.isNotEmpty ? _controller.loadHtmlString("""
      <!DOCTYPE html>
        <html>
          ...
          <link href="https://fonts.googleapis.com/css2?family=${CustomTextTheme.getTextStyle(MyTextStyle.SettingDefault, context).copyWith(fontWeight: FontWeight.bold)}&display=swap" rel="stylesheet">
          <meta name="viewport" content="width=device-width, initial-scale=0.8">
           <style>
           .change
            {
            font-family: '${CustomTextTheme.getTextStyle(MyTextStyle.SettingDefault, context).copyWith(fontWeight: FontWeight.bold)}', serif;
            }
             </style> 
            </head>
           <body class="change" style="margin: 0; padding: 0; color: #${Utils.convertColorToHex(AppTheme.primaryLightTextColor!)};">
            ${widget.body}
          </body>
        </html>
            ...
            children: [
              (urlAndBodyNotFound)
                  ? Center(
                      ...
                      "Not Found",
                      style: CustomTextTheme.getTextStyle(
                          MyTextStyle.SettingDefault, context),
                    ))
                  : widget.isLoading
                      ? Container(
